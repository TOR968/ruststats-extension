function ruststatsInjectMain() {
	...
	async function inject() {
		...
		if (!steamId) { console.warn('[Ruststats] No SteamID'); return; }
		...
		a.href = 'https://ruststats.io/profile/' + steamId;
...
export const INJECTION_CODE = `(${ruststatsInjectMain.toString()})()`;
