...
const Settings = () => {
	...
	return (
		<ToggleField
			...
			description="Opens Ruststats in your system browser instead of Steam's built-in browser. Useful when the site is behind Cloudflare, which can block the in-app browser. Reopen profile pages to apply changes."
